...
```sh
chmod +x scripts/fir_envs/rfplasmid/build_apptainer_sif.sh
./scripts/fir_envs/rfplasmid/build_apptainer_sif.sh "$benchmark_root_dir"
```
...
??? info "Script"
    ...
    ```sh title="scripts/fir_envs/rfplasmid/build_apptainer_sif.sh"
    --8<-- "scripts/fir_envs/rfplasmid/build_apptainer_sif.sh"
    ```

??? info "Apptainer definition"

    ```sh title="scripts/fir_envs/rfplasmid/apptainer_img.def"
    --8<-- "scripts/fir_envs/rfplasmid/apptainer_img.def"
    ```
